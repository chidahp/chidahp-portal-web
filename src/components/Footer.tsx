...
const socialLinks: SocialLink[] = [
  ...
  {
    href: "https://line.me/ti/p/~@chidahp",
    label: "Line",
    svgPath:
  ...
  {
    href: "https://www.tiktok.com/@chidahp",
    label: "TikTok",
    svgPath:
      ...
      <div class="flex flex-col items-center justify-center space-y-6">
        ...
        <div class="flex flex-col items-center">
          <img
            ...
            height="60"
            alt="ChiDahp Logo"
            class="w-10 h-10 rounded-full object-cover mb-3"
          />
        ...
        <div class="flex items-center space-x-4">
          {socialLinks.map(({ href, label, svgPath }) => (
            <a
              href={href}
              aria-label={label}
              class="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center hover:bg-gray-500 transition-colors"
            >
              <svg
                class="w-4 h-4"
                fill="currentColor"
